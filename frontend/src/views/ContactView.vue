<template>
  <div class="hero min-h-screen" style="background-image: url(/img/bg-contact.jpg);">
    ...
    <div class="flex flex-wrap text-center text-white w-[90%]">
      <div class="hero-content basis-1/3 flex flex-col max-w-md items-center content-start">
        <div class="">
      ...
      <div class="hero-content basis-1/3 flex flex-col max-w-md items-center">
        <div class="">
