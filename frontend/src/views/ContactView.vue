<template>
  <div class="hero min-h-[84vh] font-default" style="background-image: url(/img/bg-contact.png);">
    ...
    <div class="flex flex-col sm:flex-row text-center text-white w-[90%] justify-center">
      <div class="hero-content basis-1/3 flex flex-col w-full items-center content-center">
        ...
        <h1 class="my-5 text-3xl font-bold">WeChat US</h1>
        <p class="mb-1 text-xl">Our WeChat ID</p>
        <p class="mb-1 text-xl">Pause_ca</p>
      </div>
      <div class="hero-content basis-1/3 flex flex-col w-full items-center">
        ...
        <h1 class="my-5 text-3xl font-bold">EMAIL US</h1>
        <p class="mb-1 text-xl">Our Email Address</p>
        <p class="mb-1 text-xl">Pauseca2023@gmail.com</p>
      </div>
      <div class="hero-content basis-1/3 flex flex-col w-full items-center">
        <div class="">
        ...
        <div>
          <h1 class="mt-5 text-3xl font-bold">FOLLOW US ON</h1>
          <h1 class="mb-5 text-3xl font-bold">XIAOHONGSHU</h1>
        </div>
