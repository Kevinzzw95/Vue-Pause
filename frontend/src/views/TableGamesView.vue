<template>
    <div class="container p-4 md:p-16 2xl:p-32 space-y-10 h-screen">
...
import type { GetResponseAccs, GetResponseTableGames } from '@/types/RestData'
